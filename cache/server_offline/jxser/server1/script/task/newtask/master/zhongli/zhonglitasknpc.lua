...
-----------------------------------¸µÄÏ±ù¶Ô»°--------------------------------
function funanbing()
	Uworld1002 = nt_getTask(1002)  --ÖÐÁ¢
	local name = GetName()  
	if ( Uworld1002 == 10 ) or ( Uworld1002 == 20 )then 
		nt_setTask(1002,20)
		Describe(name.."<#>: ¤ng lµ "..DescLink_FuNanBin.."?<enter> Kh«ng sai.<enter>"
				..name.."<#>: Ngò Gia ph¸i ta ®Õn, ë ®©y cã th­ cã bót tÝch cña «ng ta. <enter> Ng­¬i ®· tõng giÕt ng­êi ch­a? <enter>"
				...
				..name.."<#>: Ninh T­íng Qu©n lµ ai? <enter> §¹i t­íng Nam Tèng, th«ng ®Þch ph¶n quèc, téi kh«ng thÓ tha. <enter>"
...
function liqiushui()
	...
	if ( Uworld1002 == 130 ) or ( Uworld1002 == 140 ) then
		nt_setTask(1002,140)
		Describe(DescLink_LiQiuShui.."<#>: Ng­¬i lµ ai? §Õn Thóy Yªn m«n víi môc ®Ých g×? <enter>"
			..name.."<#>: Ta lµ ng­êi trong héi, Nam B¨ng b¶o ta ®Õn t×m c«. <enter> Hõ! Ta ®· nãi víi hä, kh«ng nªn t×m nh÷ng kÎ v« dông. <enter>"
			..name.."<#>: Ta vèn còng ch¼ng thÝch ®ång hµnh víi c«! <enter> A! Kh«ng ngê ng­¬i còng cã tÝnh c¸ch. <enter>"
			..name.."<#>: Ta sÏ cho c« thÊy b¶n lÜnh cña ta! <enter> Nãi hay l¾m! KhÈu khÝ còng kh«ng tÖ. KiÕm m«n cã Tõ Tù Lùc ®ang gi÷ 1 b¶o vËt. §Õn ®ã lÊy nã vÒ cho ta. <enter>"
	...
	elseif ( Uworld1002 == 160 ) or ( Uworld1002 == 170 ) then 
		nt_setTask(1002,170)
		Describe(DescLink_LiQiuShui.."<#>: B¹ch Long Tøc lµ b¶o khÝ trong truyÒn thuyÕt. Hay qu¸! <enter>"
			..name.."<#>: B¶o KhÝ? Ch¼ng lÏ ®©y lµ Thiªn Hoµng Long KhÝ. <enter> Ng­¬i biÕt Thiªn Hoµng Long KhÝ? <enter>"
			..name.."<#>: Ta nghe thî rÌn nh¾c ®Õn. <enter> Thî rÌn? Kh«ng ngê trªn ®êi nµy ng­êi biÕt chuyÖn nµy còng kh«ng Ýt. B»ng h÷u, ta ®· xem th­êng ng­¬i. <enter>"
			..name.."<#>: §Òu v× L©m Uyªn Nhai mµ th«i! VÒ Long KhÝ, c« biÕt ®­îc bao nhiªu? <enter> Thiªn Hoµng Long KhÝ víi bÝ mËt cña tæ chøc cã liªn quan, ta chØ cã thÓ nãi víi ng­¬i bÊy nhiªu. <enter> C¸i nµy lµ cña ng­¬i, cÇm lÊy ®i. <enter>",1,"KÕt thóc ®èi tho¹i/middlefinish5")
...
function hanjiangdudiaosou()
	...
	if ( Uworld1002 == 200 ) or ( Uworld1002 == 210 ) then
		...
		Describe(DescLink_HanJiangDuDiaoSou.."<#>: NhÊt c¸n nhÊt l¹p nhiÖm b×nh sinh, nhÊt giang yªn ba nhÊt giang sÇu. <enter>"
			...
			..name.."<#>:N¨m x­a B¶o khÝ Long §o¹n mÊt tÝch t¹i Thiªn V­¬ng Bang, ng­êi biÕt tung tÝch cña nã kh«ng. <enter>  ChuyÖn nµy ®· l©u råi, trÝ nhí cña ta ngµy cµng kÐm, nh÷ng chuyÖn x­a kia ta ®· kh«ng cßn nhí n÷a.<enter>"
			...
			..name.."<#>: Xin «ng h·y giao ra. <enter> Nhí n¨m x­a Chung D­¬ng NhÞ V­¬ng tung hoµnh giang §éng §×nh hå, binh hïng t­íng m¹nh, ®Þnh thay ®æi thÕ ®¹o tµn khèc nµy. Nh­ng ®Õn cuèi cïng còng thÊt b¹i? Cã nh÷ng chuyÖn lµ ý trêi, ý trêi kh«ng thÓ thay ®æi! <enter>"
			..name.."<#>:L·o TiÒn Bèi! ChuyÖn sau nµy ®Ó sau nµy h·y nãi. B©y giê «ng giao Long §o¹n ra, ta cã thÓ b¶o ®¶m tÝnh m¹ng cña «ng.<enter> Ha ha ha! Ta sèng kh«ng bao l©u n÷a, c¸i m¹ng giµ nµy th× cã ®¸ng g×? <enter>"
	...
	elseif ( Uworld1002 >= 220 ) then
		Describe(name.."<#>: Hµn l·o tiÒn bèi xin b¶o träng, ta vÒ sÏ thay «ng nãi. <enter>"..DescLink_HanJiangDuDiaoSou.."<#>: Kh«ng cÇn ®©u! B¹n trÎ h·y nhí lÊy: ngµy nµo Long KhÝ cã ®ñ bé, thiªn h¹ sÏ ®¹i lo¹n. <enter>"
			..name.."<#>: T¹i h¹ nhí råi. ", 1, "KÕt thóc ®èi tho¹i/no")
	else
		Describe(DescLink_HanJiangDuDiaoSou.."<#>:  §éc c©u hµn giang, t©m nh­ chÝnh thñy, ung dung tù t¹i!",1,"KÕt thóc ®èi tho¹i/no")
	end
end
...
function shaolinkongji()
	...
	if ( Uworld1002 == 260 ) or ( Uworld1002 == 270 ) then
		nt_setTask(1002,270)
		Describe(DescLink_KongJi.."<#>: A Di §µ PhËt!  ThÝ chñ s¸t khÝ qu¸ nÆng. <enter>"
			..name.."<#>: Suèt ngµy chØ biÕt chÐm giÕt, ®­¬ng nhiªn s¸t khÝ nÆng råi! <enter> T¹o nhiÒu nghiÖp ¸c, ThÝ chñ ngµy sau sÏ bÞ ®µy xuèng ®Þa ngôc A Tú,  khæ ¶i v« biªn, quay ®Çu lµ bê. <enter>"
			...
			..name.."<#>: ThÇn T¨ng! §¹o bÊt ®ång bÊt t­¬ng vi m­u, xin giao hai bé ThÇn khÝ mµ quÝ tù ®ang gi÷. <enter> H·y ra c¸nh rõng ë hËu s¬n ThiÕu L©m, BÇn T¨ng thä gi¸o vµi chiªu sÏ nãi! <enter>",
			1, "KÕt thóc ®èi tho¹i/middlefinish8")
	elseif ( Uworld1002 >= 290 ) then
		Describe(name.."<#>: ThÇn T¨ng, xin ®¾c téi. <enter>"..DescLink_KongJi.."<#>:A Di §µ PhËt! ThiÖn ¸c ®Òu ®Þnh s½n, ý trêi khã ®æi. ThÝ chñ ®i ®i, trªn ®êi ¾t cã nh©n qu¶. <enter>",1,"KÕt thóc ®èi tho¹i/no")
	else
		Describe(DescLink_KongJi.."<#>: Nh©n qu¶ trªn ®êi ®· ®Þnh s½n. A Di §µ PhËt!",1,"KÕt thóc ®èi tho¹i/no")
	end
end
...
function middlefinish8()
	AddOwnExp(50000)
	nt_setTask(1002,280)
	Msg2Player("Kh«ng TÞch ThÇn T¨ng b¶o ®Õn HËu s¬n ThiÕu L©m Tù t×m «ng ta")	
end
