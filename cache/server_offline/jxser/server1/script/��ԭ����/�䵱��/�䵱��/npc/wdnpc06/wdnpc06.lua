...
function main()
	...
	local szTitleMsg = "<npc>GÇn ®©y ta cã rÊt nhiÒu viÖc gi¶i quyÕt, ng­¬i ®Õn ®©y cã viÖc g×."
	local tbOpt = 
	{
		{"NhiÖm vô kü n¨ng cÊp 150", dailog150skill},
		{"Muèn thØnh gi¸o viÖc kh¸c", org_dailog}
	}
