...
function default_talk()
	...
	if ((UTask_world42 == 0) and (GetLevel() >= 80) and (GetReputeLevel(GetRepute()) >= 7)) then		-- ÈÎÎñÆô¶¯£¬ÉùÍûµÈ¼¶ºÍÉùÍûÖµµÄ¹ØÏµ²»ÊÇºÜÃ÷È·£¬ÒªÎÊÃ÷°×
		Talk(6,"U42_get","Cöa thµnh vÖ binh gi¸p: Nghe nãi trong thµnh gÇn nhÊt giµ cã tiÓu hµi v« cí mÊt tİch?","Cöa thµnh vÖ binh Êt: §u´ng v©?y a. Ta nguyªn lai nh©n t×nh l¸ hoa, nµng NhŞ tiÓu tö còng kh«ng thÊy, gÇn nhÊt th­êng ®Õn phiÒn ta gióp nµng t×m nhi tö.","Ng­êi ch¬i: Hai vŞ, ®Õn cuèi cïng lµm sao?","Cöa thµnh vÖ binh gi¸p: Ha ha, vŞ ®¹i hiÖp nµy d¸ng vÎ ®­êng ®­êng, anh minh thÇn vâ, xem ra lµ muèn qu¶n qua?n viÖc bÊt b×nh nµy?","Ng­êi ch¬i: Kh¸ch khİ, GÆp bÊt b×nh rót ®ao t­¬ng trî lµ bæn phËn cña nh÷ng ng­êi hµnh tÈu giang hå.","Cöa thµnh vÖ binh Êt: Ai nha, ®ªm nay tiÒn th­ëng d­êng nh­ kh«ng mang ®ñ a!")
	else
