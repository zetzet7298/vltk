...
function main(sel)
	...
	elseif (i == 1) then
		Talk(1,"","T©y Phông töu lµ ®Æc s¶n cña Ph­îng T­êng. Do Ph­îng T­êng ë phÝa T©y bé nªn gäi lµ T©y Phông töu.")
	elseif (i == 2) then
		Talk(1,"","Lo¹i T©y Phông töu nµy ®· cã lÞch sö mÊy tr¨m n¨m, tõ ®êi nhµ §­êng ®· ®­îc liÖt vµo lo¹i cèng phÈm d©ng cho hoµng cung")
	else
