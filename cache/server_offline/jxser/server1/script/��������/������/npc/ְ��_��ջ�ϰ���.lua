--ÁúÃÅÕò Â·ÈË ¿ÍÕ»ÀÏ°åÄï ÐÂÊÖÈÎÎñ£º½éÉÜ¹¤×÷
...
function main(sel)
	...
	if (UTask_world25 == 3) then		-- ÈÎÎñ¡°½éÉÜ¹¤×÷¡±½øÐÐÖÐ
		Talk(5,"W25_step","Bµ chñ! Cã cÇn thªm ng­êi gióp viÖc kh«ng?","Gióp viÖc? HiÖn cßn ®ang thiÕu mét ch©n tiÓu nhÞ ®Ó dän bµn","Cã ng­êi muèn dù tuyÓn, vËy nhËn kh«ng?","Cßn xem kh¶ n¨ng!","Tõ trung Nguyªn ®Õn ®©y, t×m mét b÷a c¬m thËt kh«ng dÔ dµng")
	...
	elseif (UTask_world27 == 5) then
		...
		if (i >= 3) then
			...
			SetTask(27,10)
			AddRepute(9)
			AddNote("H·y mau ®em thÞt heo rõng vÒ giao cho bµ chñ, hoµn thµnh nhiÖm vô! ")
			Msg2Player("H·y mau ®em thÞt heo rõng vÒ giao cho bµ chñ, hoµn thµnh nhiÖm vô! ")
			...
			Talk(1,"","Lµm g× mµ cø ®øng thÇn ng­êi ra vËy? Xem bé d¹ng cña ng­¬i k×a! Cßn ch­a chÞu ®i?!")
		end
...
function W25_step()
	...
	SetTask(25,6)
	AddNote("Bµ chñ ®· ®ång ý mêi Th­îng Quan Thu ®Õn ®©y gióp vÖc! H·y mau mang tin vui nµy ®Õn cho h¾n! ")
	Msg2Player("Bµ chñ ®· ®ång ý mêi Th­îng Quan Thu ®Õn ®©y gióp vÖc! H·y mau mang tin vui nµy ®Õn cho h¾n! ")
end

function W27_get_yes()
	SetTask(27,5)
	AddNote("NhËn nhiÖm vô! Vµo rõng lÊy 3 miÕng thÞt heo rõng vÒ giao cho bµ chñ! ")
	Msg2Player("NhËn nhiÖm vô! Vµo rõng lÊy 3 miÕng thÞt heo rõng vÒ giao cho bµ chñ! ")
end
