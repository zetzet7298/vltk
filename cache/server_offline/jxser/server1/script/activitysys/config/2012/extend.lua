...
Include("\\script\\activitysys\\config\\2012\\data.lua")
...
function pActivity:AddAmbienceNpc()
	Include("\\script\\activitysys\\config\\2012\\ambience_npc.lua")
...
function pActivity:CheckPerson(szFun, nParam)
	...
	obj:Push(GetName())
	obj:Push(nParam)
	DynamicExecute("\\script\\activitysys\\config\\2012\\extend.lua",
