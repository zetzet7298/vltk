...
tbMaterial_Shijin = {szName="Ph¸o §¹i",tbProp={6,1,1353,1,0,0},nExpiredTime=nTime,nCount=2,}
tbMaterial_Money = {szName="Ng©n L­îng",nJxb=3000,nCount=1,}	

tbProduct = {
	[1] = {szName="Phong Ph¸o Trung §Æc BiÖt",tbProp={6,1,1355,1,0,0},nExpiredTime=nTime,},
