-- Chñ lö qu¸n ë Nam Nh¹c TrÊn - Editor by AloneScript (Linh Em)
...
function main(sel)
	...
	Say("<color=green>Chñ lö qu¸n<color>: Ng­êi còng lªn nói b¸i kiÕn §éc C« §¹i hiÖp sao? Nh­ng «ng Êy lµ thÇn t­îng cña ta. GÆp ®­îc «ng ta, phiÒn «ng Êy viÕt cho ta mét ch÷"..Note("chuluquan_namnhactran"),0);
