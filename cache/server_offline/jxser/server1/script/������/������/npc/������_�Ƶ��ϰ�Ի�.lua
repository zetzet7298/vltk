-- ¤ng chñ töu ®iÕm ë Nam Nh¹c TrÊn - Editor by AloneScript (Linh Em)
...
function main(sel)
	...
	return elseif ( GetTask(1256) == 2 ) then
		Talk(1,"","Nghe nãi cã mét vŞ s­ th¸i kh«ng biÕt tõ miÕu nµo ®Õn, ph¸p lùc v« biªn ng­¬i ®i hái thö xem sao.")
	return end
	Say("<color=green>¤ng chñ töu ®iÕm<color>: Sau khi §éc C« §¹i HiÖp cña Hoµnh S¬n lµm Vâ L©m Minh Chñ, nam Nh¹c TrÊn nhá cña chóng ta còng n¸o nhiÖt h¼n lªn; c¸c hiÖp kh¸ch kiÕm hiÖp ®Õn ®©y rÊt nhiÒu, lµm ¨n bu«n b¸n cña qu¸n r­îu nhá nµy còng ®¾t h¬n tr­íc"..Note("ongchutuudiem_namnhactran"),0);
end;
