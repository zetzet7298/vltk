-- §iÒn Th¸i Bµ ë Nam Nh¹c TrÊn - Editor by AloneScript (Linh Em)
...
function main(sel)
	...
	return elseif ( GetTask(1256) == 2 ) then
		Talk(1,"","Nghe nãi cã mét vŞ s­ th¸i kh«ng biÕt tõ miÕu nµo ®Õn, ph¸p lùc v« biªn ng­¬i ®i hái thö xem sao.")
	return end
	Say("<color=green>§iÒn Th¸i Bµ<color>: Con ta cßn sèng còng lín gièng nh­ ng­¬i, råi chØ ®¸ng tiÕc lóc nã 15 tuæi ®· bŞ bÖnh chÕt ®Ó mét m×nh l·o sèng c« ®éc thÕ nµy"..Note("dienthaiba_namnhactran"),0)
end;
