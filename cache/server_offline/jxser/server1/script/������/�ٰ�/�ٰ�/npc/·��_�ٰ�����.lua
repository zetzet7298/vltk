...
function main(sel)
	...
	if (Uworld43 < 10) and (GetLevel() >= 70) and (GetReputeLevel(GetRepute()) >= 6) then
				Say(10713 ,2,"Th¸i Hoa TÆc thËt kh«ng thÓ tha thø, nay ®Ó ta biÕt ®­îc, kh«ng thÓ kh«ng xen vµo/U43_get","Ta kh«ng muèn tham gia/no")
	elseif (Uworld43 == 40) and (HaveItem(381) == 1) then
