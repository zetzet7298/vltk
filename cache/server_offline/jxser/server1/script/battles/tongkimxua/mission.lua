...
-------------------------------------------------------------------------
	...
	StartMissionTimer(MISSIONID, 116, TIMER_2);
	--Ëæ»úÄ£Ê½ÐèÒª´ò¿ªÃ¿X·ÖÖÓ´¥·¢Ò»´ÎµÄ´¥·¢Æ÷£¬ÒÔ²úÉúÐÂÆì
	StartMissionTimer(MISSIONID, 115, TIMER_1);
	...
	local str1 = lvlstr.."ChiÕn tr­êng Tèng Kim (B¶o vÖ Nguyªn So¸i) ®ang trong giai ®o¹n b¸o danh. Muèn tham gia h·y nhanh chãng ®Õn T­¬ng D­¬ng hoÆc Chu Tiªn trÊn ®Ó b¸o danh! (hoÆc dïng Tèng Kim Chiªu th­) .Thêi gian b¸o danh cßn l¹i lµ::"..RestMin.."phót"..RestSec.."gi©y. §iÒu kiÖn tham gia: ®¼ng cÊp tõ 40. phÝ b¸o danh 3000 l­îng";
	AddGlobalNews(str1);
	...
	BT_SetMissionName("B¶o vÖ Nguyªn so¸i")
...
function EndMission()
	...
	StopMissionTimer(MISSIONID, 116);
	StopMissionTimer(MISSIONID ,115);
