...
FILE_HOMETRAP1 = "\\script\\battles\\tongkimxua\\hometrap1.lua";
FILE_HOMETRAP2 = "\\script\\battles\\tongkimxua\\hometrap2.lua";
FILE_CENTERTRAP = "\\script\\battles\\tongkimxua\\centertrap.lua";
FILE_CENTERTOHOMETRAP1 = "\\script\\battles\\tongkimxua\\homeouttrap1.lua"
FILE_CENTERTOHOMETRAP2 = "\\script\\battles\\tongkimxua\\homeouttrap2.lua"

tabFILE_NPCDEATH = 
	{
	"\\script\\battles\\tongkimxua\\npcdeath_1.lua",
	"\\script\\battles\\tongkimxua\\npcdeath_2.lua",
	"\\script\\battles\\tongkimxua\\npcdeath_3.lua",
	"\\script\\battles\\tongkimxua\\npcdeath_4.lua",
	"\\script\\battles\\tongkimxua\\npcdeath_5.lua",
...
FILE_DOCTOR1 = 	"\\script\\battles\\tongkimxua\\doctor.lua";
FILE_DOCTOR2 = 	"\\script\\battles\\tongkimxua\\doctor.lua";
FILE_SYMBOLNPC = ""
FILE_DEPOSIT = 	"\\script\\battles\\openbox.lua"
FILE_DEATH = "\\script\\battles\\tongkimxua\\npcdeath.lua"
...
gametime = floor(GetMSRestTime(MISSIONID, 116) / 18);
...
SetPKFlag(1)
ForbidChangePK(1);
SetDeathScript("\\script\\battles\\tongkimxua\\playerdeath.lua");
bt_JudgePLAddTitle()
end;
------------------------------------------------------------------
...
function sf_buildfightNPC(lv)
	...
	for i = 1, 6 do 
		...
		tnpcid=NPCTONG[lv][i][1]
		level=NPCTONG[lv][i][2]
		count=NPCTONG[lv][i][3]
	...
	bt_addrandfightnpc(npcfile, GetMissionV(MS_TRANK1_S), GetMissionV(MS_RANK1LVL_S), 1, GetMissionV(MS_NPCCOUNT1_S), tabFILE_NPCDEATH[1], nil,nil,0)
	
	--¿ªÊ¼Ê±Ê¿±øÒ»´ÎÈ«²¿³öÏÖ¡ª¡ª¡ª¡ª½ð
	npcfile = GetIniFileData(mapfile, "Area_"..j_area, tbNPCPOS[2]);
	bt_addrandfightnpc(npcfile, GetMissionV(MS_TRANK1_J), GetMissionV(MS_RANK1LVL_J), 2, GetMissionV(MS_NPCCOUNT1_J), tabFILE_NPCDEATH[1], nil,nil,0)
