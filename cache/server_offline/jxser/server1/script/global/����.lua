" xin chê chèc l¸t . ", 
" ngµi lÊy ®­îc mét ch÷ ®éc nhÊt ", 
" thÊt b¹i , #<color=red>", 
"<color># ch÷ còng kh«ng ph¶i tèt nh­ vËy hîp thµnh ®Õn ®Ých , lÇn sau trë l¹i thö mét chót tay khÝ ®i . ", 
" muèn hîp thµnh “<color=red>", 
"<color>” ch÷ cÇn <color=red>", 
"<color> , ngµi kh«ng cã cÇn thiÕt ®Ých ch÷ ®©y # cã ph¶i hay kh«ng quªn mang theo ? mau ®i trë vÒ t×m mét chót trë l¹i ®i . ", 
...
local mpay = 1000 -- script viet hoa By http://tranhba.com  cÇn tr¶ ®Ých kim tiÒn sè l­îng 
...
SetTaskTemp(250, 0) -- script viet hoa By http://tranhba.com  thiÕt trÝ tr­íc mÆt ®Ò môc v× thø 0 ®Ò 
SetTaskTemp(251, 0) -- script viet hoa By http://tranhba.com  thiÕt trÝ tr­íc mÆt c©u tr¶ lêi v× thø 0 
Pay(mpay) 
gquestion() 
else 
Say(STR_Guess[1], 1, 
...
-- script viet hoa By http://tranhba.com  phÝa d­íi lµ n¨m ®Ò môc 
function gquestion() 
...
local qid = random(qid_min, qid_max) -- script viet hoa By http://tranhba.com  x¸c ®Þnh mét ®Ò môc ID 
...
SetTaskTemp(250, gttc) -- script viet hoa By http://tranhba.com  ®ang tiÕn hµnh ®Ých ®Ò môc ®æi phiªn lÇn 
SetTaskTemp(251, 0) 
...
SetTaskTemp(251, qanswer) -- script viet hoa By http://tranhba.com  ký lôc ®­¬ng tr­íc vÊn ®Ò c©u tr¶ lêi 
Say(question, 4, 
...
if (GetTaskTemp(251) == 1) then -- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng chÝnh x¸c c©u tr¶ lêi 
...
if (GetTaskTemp(251) == 2) then -- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng chÝnh x¸c c©u tr¶ lêi 
if (GetTaskTemp(250) >= 5) then 
add_random_special_word() 
else 
gquestion() 
...
if (GetTaskTemp(251) == 3) then -- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng chÝnh x¸c c©u tr¶ lêi 
if (GetTaskTemp(250) >= 5) then 
add_random_special_word() 
else 
gquestion() 
...
if (GetTaskTemp(251) == 4) then -- script viet hoa By http://tranhba.com  cã ph¶i lµ hay kh«ng chÝnh x¸c c©u tr¶ lêi 
if (GetTaskTemp(250) >= 5) then 
add_random_special_word() 
else 
gquestion() 
...
function qfail() -- script viet hoa By http://tranhba.com  tr¶ lêi bÞ lçi 
end 
-- script viet hoa By http://tranhba.com  ®Ò môc kÕt thóc 

function add_random_special_word() 
local qitem = {426,427,428,429,430,431,432,433} -- script viet hoa By http://tranhba.com  ký lôc cã kh¶ n¨ng t­ëng lÖ ®¹o cô ( ki tû sè thÊt xøng ) 
local qitem_rate = {763,863,913,963,983,993,998,1000} -- script viet hoa By http://tranhba.com  ký lôc cã kh¶ n¨ng t­ëng lÖ ®¹o cô xuÊt hiÖn ki tû sè 
...
local drop_rate = random(1, accuracy) -- script viet hoa By http://tranhba.com  x¸c ®Þnh t­ëng phÈm lo¹i h×nh ®Ých mét tïy ki sæ 
...
function yes4() -- script viet hoa By http://tranhba.com  t¸m tr©n phóc th¸ng ®oµn viªn bÝnh 
...
function yes8() -- script viet hoa By http://tranhba.com  ®Þnh quèc an bang hoµng kim trang bÞ 
