...
function get_ingot()
	...
	if (nMoney <= 0) then					-- Ã»ÓĞÀ©Õ¹µãÊı
		...
		local nCurVar = nMoney *COIN/10
		Say("<#> Kh¸ch quan ®· göi t¹i bæn trang  tæng céng <color=green>"..nCurVar.."<color> TiÒn §ång. Cã muèn lÊy ra kh«ng?", 2, "Ta muèn lÊy ra "..COIN.." TiÒn §ång/get_ingot10", "Kh«ng lÊy/no")
	end
end
