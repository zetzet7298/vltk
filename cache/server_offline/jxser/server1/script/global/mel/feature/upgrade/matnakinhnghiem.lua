...
--                                       MÆt N¹ Kinh NghiÖm                                       --
----------------------------------------------------------------------------------------------------
if (not tbMaskExpUpgrade) then
    tbMaskExpUpgrade = {}
end

tbMaskExpUpgrade.nReqTDTT      = 5
tbMaskExpUpgrade.nReqPhoi      = 1
tbMaskExpUpgrade.nReqMoney     = 20000000
tbMaskExpUpgrade.tbJewelryNames = {
    "Hång ¶nh ThÈm Viªn UyÓn",
    "Hång ¶nh KiÕm Bµi",
    "Hång ¶nh Môc Tóc",
    "Hång ¶nh Tô Chiªu"
}
tbMaskExpUpgrade.nTargetMaskID = 1115

function tbMaskExpUpgrade:Main()
    local szMsg = "<npc><enter>Ng­¬i muèn n©ng cÊp <color=gold>MÆt N¹ Kinh NghiÖm<color>?\n" ..
                  "CÇn cã:\n" ..
                  "<color=green>- Bé trang bÞ Hång ¶nh\n" ..
                  "- Ph«i MÆt N¹\n" ..
...
function tbMaskExpUpgrade:OpenUI()
    g_GiveItemUI("N©ng CÊp MÆt N¹ Kinh NghiÖm", "Bá vµo:<enter>- Bé trang bÞ Hång ¶nh<enter>- Ph«i MÆt N¹<enter>- 5 TuyÖt §Ønh Tri Thøc", {self.OnConfirm, {self}}, nil, 1)
end

function tbMaskExpUpgrade:OnConfirm(nNum)
    ...
    if (NewIdx > 0) then
        SyncItem(NewIdx)
        Msg2Player("N©ng cÊp thµnh c«ng <color=gold>MÆt N¹ Kinh NghiÖm<color>!")
        Msg2SubWorld("<color=green>"..GetName().."<color> ®· n©ng cÊp thµnh c«ng <color=gold>MÆt N¹ Kinh NghiÖm<color>!")
    end
    return 1
end