...
function main()
	dofile("script/global/mel/item/lunglinhhap.lua")
	if GetSex() == 1 then
...
function OnTimer(nNpcIndex,nTimeOut)
	if NPCAutoChat == 1 then
		local tab_Chat = {
			...
			"<pic=36><bclr=blue><enter>Ta cã thÓ gióp hay ®æi ngo¹i h×nh!<bclr>",
		}
