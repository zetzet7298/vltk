...
visible art are sourced 100% from the PC client (`vltksource_new`); no fabricated art and
...
genuine decoded PC SPR from `vltksource_new`, resolved by JX Pack Hash (GBK path → hash →
