...
- PC source rule was applied. The configured source path `/var/www/jx-pc/01_tinh_kiem_source/source/00.src-tinh-kiem` is absent in this environment, so this change uses the available PC-derived reference and unpacked client evidence:
  ...
  - Resolved SPR: `/var/www/jx-pc/pak_unpacked/update01/unknown/bf787a8a.spr` and `/var/www/jx-pc/pak_unpacked/spr/unknown/bf787a8a.spr`.
