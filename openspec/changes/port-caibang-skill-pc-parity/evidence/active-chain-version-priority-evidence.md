...
- `/var/www/vltksource_new/vl_update_27/pak_unpacked/_slistcache/script/skill/gaibang.lua`
...
- `/var/www/vltksource_new/vl_update_27/Server 6.0/server/home_jxser/server1/script/skill-goc/gaibang.lua`
