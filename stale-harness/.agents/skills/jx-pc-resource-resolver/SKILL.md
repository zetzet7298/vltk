...
description: Resolve JX Online 1 / Vo Lam Truyen Ky PC PAK, SPR, Hash_UID, encoded resource paths, and runtime assets using the canonical jx-pc corpus and vltktool. Use whenever a PC resource must be identified, selected, decoded, or verified.
---
...
- PC corpus, read-only: `/var/www/jx-pc`
- Unpacked runtime/PAK data: `/var/www/jx-pc/pak_unpacked/`
...
6. Verify the selected file under `/var/www/jx-pc/pak_unpacked/` and report its absolute path, pack/version, winner, Hash_UID, path bytes/encoding, byte count, and SHA-256.
