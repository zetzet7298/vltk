...
# Find JX PAK files
PAK_DIRS = [
    Path('/var/www/jx-pc/01_tinh_kiem_source/source/00.src-tinh-kiem/SwordOnline/Sources/S3Client/Debug/data'),
    Path('/var/www/jx-pc/01_tinh_kiem_source/source/00.src-tinh-kiem/bin/client/data'),
]
