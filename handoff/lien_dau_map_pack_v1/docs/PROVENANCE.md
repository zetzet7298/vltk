...
- PC root: `/var/www/vltksource_new/vl_update_27`
- Canonical unpack root: `/var/www/vltksource_new/vl_update_27/pak_unpacked`
- PC maplist evidence:
  - `/var/www/vltksource_new/vl_update_27/Client 6.0/settings/maplist.ini`
