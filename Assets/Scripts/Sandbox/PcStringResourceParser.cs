...
namespace VLTK.Sandbox
{
    ...
    public static class PcStringResourceParser
    {
        public static PcStringResourceRegistry BuildRegistry(string absoluteDir)
        {
            ...
            // stringresource.txt ships as Vietnamese TCVN3 (windows-1252 bytes + TCVN3 glyph
            // codes). Auto-detect (DecodeBest) is GBK-biased and mis-decodes the localized
            // text column into hanzi/mojibake; force the deterministic TCVN3 path. See
            // kanban t_278a9ad8 systemic decode audit.
