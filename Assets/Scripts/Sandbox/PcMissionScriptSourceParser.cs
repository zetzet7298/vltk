...
// Source of truth: /var/www/vltksource_new/01_tinh_kiem_source/source/00.src-tinh-kiem/bin/Server/Server/script/missions
...
{
    public static class PcMissionScriptSourceParser
    {
        public const string CatalogFileName = "mission_scripts.txt";
        public const string PcSourceRelativeRoot = "Server 6.0/server/home_jxser/server1/script/missions";
        ...
        public static List<PcMissionScriptSourceEntry> ParseFile(string path)
        {
            var rows = new List<PcMissionScriptSourceEntry>();
            ...
            foreach (var raw in ReadUtf8Lines(path))
            {
                ...
                sourceIndex++;
                var entry = new PcMissionScriptSourceEntry
                {
        ...
        public static PcMissionScriptSourceCatalog BuildCatalog(string dirOrFile)
        {
            var catalog = new PcMissionScriptSourceCatalog();
    ...
    [Serializable]
    public sealed class PcMissionScriptSourceEntry
    {
