    ...
    public static class SkillSectCatalog
    {
        ...
        private static SectInfo BuildCaiBang() => new()
        {
            ...
            skills = new List<SectSkillEntry>
            {
                ...
                S(117, "Đầu Thạch Vấn Lộ",      "Đầu Thạch Vấn Lộ",       SkillTier.Active,  10, 20, charAnim: 4, melee: true),
                S(118, "Cô Mộc Độn Lôi",        "Cô Mộc Độn Lôi",         SkillTier.Buff,    10, 20),
                S(119, "Diên Môn Thác Bát",      "Diên Môn Thác Bát",      SkillTier.Active,  10, 20, charAnim: 4, melee: true),
                S(120, "Bôn Lưu Đáo Hải",        "Bôn Lưu Đáo Hải",        SkillTier.Buff,    20, 20),
                S(121, "Diệu Thủ Không Không",   "Diệu Thủ Không Không",   SkillTier.Utility, 20, 20),
                S(122, "Kiến Nhân Thần Thủ",     "Kiến Nhân Thần Thủ",     SkillTier.Active,  10, 20, charAnim: 4, melee: true),
                S(123, "Khuê Mộc Tinh Chiếu",    "Khuê Mộc Tinh Chiếu",    SkillTier.Buff,    30, 20),
                S(124, "Đả Cẩu Bổng",            "Đả Cẩu bổng",            SkillTier.Passive, 30, 20),
                S(125, "Bổng Đả Ác Cẩu",         "Bổng Đả ác Cẩu",        SkillTier.Active,  50, 20, charAnim: 3, melee: true),
                S(126, "Kim Ô Ánh Tuyết",        "Kim Ô ánh Tuyết",        SkillTier.Buff,    40, 20),
                S(127, "Hoạt Bất Lưu Thủ",       "Hoạt Bất Lưu Thủ",      SkillTier.Utility, 10, 20),
                S(128, "Kháng Long Hữu Hối",     "Kháng Long Hữu Hối",     SkillTier.Active,  50, 20, charAnim: 2, melee: true),
                S(129, "Hóa Hiểm Vi Di",         "Hóa Hiểm Vi Di",         SkillTier.Buff,    20, 20),
                S(130, "Túy Điệp Cuồng Vũ",      "Túy Điệp Cuồng Vũ",     SkillTier.Ultimate, 60, 30),
            },
        };
