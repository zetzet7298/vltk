    ...
    public static class SkillSectCatalog
    {
        ...
        private static SectInfo BuildCaiBang() => new()
        {
            ...
            skills = new List<SectSkillEntry>
            {
                ...
                S(121, "Diệu Thủ Không Không",   "Diệu Thủ Không Không",   SkillTier.Utility, 20, 20, charAnim: 11),
                ...
                S(125, "Bổng Đả Ác Cẩu",         "Bổng Đả Ác Cẩu",        SkillTier.Active,  50, 20, charAnim: 11),
                S(126, "Kim Ô Ánh Tuyết",        "Kim Ô ánh Tuyết",        SkillTier.Buff,    40, 20),
                S(127, "Hoạt Bất Lưu Thủ",       "Hoạt Bất Lưu Thủ",       SkillTier.Buff,    10, 20, charAnim: 11),
                ...
                S(130, "Túy Điệp Cuồng Vũ",      "Túy Điệp Cuồng Vũ",     SkillTier.Ultimate, 60, 30, charAnim: 11),
            },
        };
