...
| P5 | E2: Inventory panel | character + inventory grid + tooltip, open/close, drag-drop | existing-behavior, public-contracts | E2a ✅ grid+item+swap (JxInventoryState, 22 tests); E2b tooltip + adapter todo |
