...
**Date**: 2026-06-16
**Source 1 (Stock)**: `/var/www/vltksource_new/vl_update_27/` — PC original
...
- Stock: `/var/www/vltksource_new/vl_update_27/Server 6.0/server/home_jxser/server1/script/skill/gaibang.lua`
