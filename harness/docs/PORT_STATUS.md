...
- **PC source repository created**: `/var/www/jx-source/` (new git repo, 4 commits, 236,258 files tracked) — extracted Tình Kiếm 2023 C++ engine source from Google Drive `1Z-iT969-Lb4saLtBNrHK3ZGEWx6YoqtR` (10 parts, password "1"). Found `KSkills.cpp/h` (108KB+12KB), `KNpc.cpp` (193KB), `KNpcAttribModify.cpp` (35KB), `KSkillList.cpp` (25KB) — full C++ source for cast delay dispatch, attribute apply, aura/passive logic. Documented in `/var/www/jx-source/docs/PC_CAST_DELAY_SOURCE_VERIFIED.md`.
