...
|---------|----------|---------|
| Map visual coverage (đủ 1,005 PC map aliases) | ✅ done: 332 unique geometries / 1,005 aliases; còn interaction/Lua validation | 🔴 |
