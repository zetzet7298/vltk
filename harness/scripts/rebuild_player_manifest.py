...
PC_MAN_DIR = Path("/var/www/vltksource_new/vl_update_27/Client 6.0/spr/npcres/man")
PC_WOMAN_DIR = Path("/var/www/vltksource_new/vl_update_27/Client 6.0/spr/npcres/woman")
