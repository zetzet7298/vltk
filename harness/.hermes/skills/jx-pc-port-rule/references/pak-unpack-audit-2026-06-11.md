...
Use this when deciding whether to delete/rebuild `/var/www/vltksource_new/pak_unpacked` or repair it incrementally.
...
Command driver used `/tmp/full_reunpack_v3.py`, calling `~/Projects/vltktool/unpak_tool.py -f -o /var/www/vltksource_new/pak_unpacked` with scoped scan dirs from Client/Server settings and script folders.
