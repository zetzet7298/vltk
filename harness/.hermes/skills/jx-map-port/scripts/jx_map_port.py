...
The default data source is /var/www/vltksource_new/01_tinh_kiem_source/source/00.src-tinh-kiem/bin/client/data, then the
mounted VMDK if the extracted source tree is unavailable.
"""
import argparse, struct, ctypes, os, json, glob, shutil, sys

DEFAULT_PC_ROOT = "/var/www/vltksource_new/01_tinh_kiem_source/source/00.src-tinh-kiem"
