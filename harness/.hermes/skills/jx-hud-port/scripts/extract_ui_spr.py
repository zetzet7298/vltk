...
USAGE (you MUST pass an explicit --file or --src; this script refuses to scan everything)
    ...
    python3 extract_ui_spr.py --file '/var/www/vltksource_new/vl_update_27/pak_unpacked/.../jx1024.spr'

    # a single narrow folder (e.g. one pak's UI subdir) -> PNGs
    python3 extract_ui_spr.py --src '/var/www/vltksource_new/vl_update_27/pak_unpacked/<pak>/<uidir>'
...
PAK_UNPACKED = "/var/www/vltksource_new/vl_update_27/pak_unpacked"
