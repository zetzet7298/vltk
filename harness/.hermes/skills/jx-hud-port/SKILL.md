...
- INI + SPR art live in the canonical unpacked PAK source tree first: `/var/www/vltksource_new/pak_unpacked/00.src-tinh-kiem/Client 6.0/data/<pak>/...`
...
`/var/www/vltksource_new/pak_unpacked/_SOURCE_OF_TRUTH.txt` and `~/Projects/vltktool/README.md`. Do not write ad-hoc
...
2. **Prefer already-unpacked files** under `/var/www/vltksource_new/pak_unpacked`; only decompress with `~/Projects/vltktool/unpak_tool.py` if the canonical tree/manifest proves a repair case is needed.
