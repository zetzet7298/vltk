...
- PC skill data:
  - `/var/www/vltksource_new/vl_update_27/bin/Client/Settings/Skills.txt`
  - `/var/www/vltksource_new/vl_update_27/bin/Server/Settings/Skills.txt`
  - `/var/www/vltksource_new/vl_update_27/Utility/Run/Script/skill/**`
- PC skill UI:
  - `/var/www/vltksource_new/vl_update_27/bin/Client/Ui/Ui3/UiSkillsSheet.ini`
  - `/var/www/vltksource_new/vl_update_27/bin/Client/Ui/Ui3/UiSkillsFightSub.ini`
  - `/var/www/vltksource_new/vl_update_27/bin/Client/Ui/Ui3/UiSkillsLive.ini`
  - `/var/www/vltksource_new/vl_update_27/SwordOnline/Sources/S3Client/Ui/UiCase/UiSkills.cpp`
  - `/var/www/vltksource_new/vl_update_27/SwordOnline/Sources/S3Client/Ui/UiCase/UiSkillTree.cpp`
- PC skill logic:
  - `/var/www/vltksource_new/vl_update_27/SwordOnline/Sources/Core/Src/CoreShell.cpp`
  - `/var/www/vltksource_new/vl_update_27/SwordOnline/Sources/Core/Src/KSkillList.cpp`
