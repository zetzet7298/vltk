...
- Đọc song song 2 file:
  - Client: `/var/www/vltksource_new/vl_update_27/Client 6.0/settings/npcs.txt`
  - Gốc Trung Quốc: `/var/www/vltksource_new/vl_update_27/pak_unpacked/dmjx06/settings/npcs.txt`
- Với mỗi dòng:
