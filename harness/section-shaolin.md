...
> `/var/www/vltksource_new/vl_update_27/Server 6.0/server/home_jxser_bachkim_6.0/server1/script/skill/shaolin.lua`
...
7. `/var/www/vltksource_new/vl_update_27/Server 6.0/.../script/skill/shaolin.lua` — main PC gốc (GB2312, 450 dòng)
8. `/var/www/vltksource_new/vl_update_27/Server 6.0/.../script/skill1/shaolin.lua` — saolin cập nhật (TCVN3 pinyin comments)
9. `/var/www/vltksource_new/vl_update_27/Server 6.0/.../script/skill/shaolin/*.lua` — 11 per-skill pinyin (TCVN3)
10. `/var/www/vltksource_new/vl_update_27/Server 6.0/.../script/skill/saolin/*.lua` — 19 per-skill GB2312
