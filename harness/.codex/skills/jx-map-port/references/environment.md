...
```bash
ls '/var/www/vltksource_new/vl_update_27/Client 6.0/data/maps.pak'
ls '/var/www/vltksource_new/vl_update_27/Client 6.0/settings/maplist.ini'
```
...
| What | Path |
|---|---|
| Client paks (primary) | `/var/www/vltksource_new/vl_update_27/Client 6.0/data/*.pak` |
| MapList.ini (primary) | `/var/www/vltksource_new/vl_update_27/Client 6.0/settings/maplist.ini` (GBK) |
| Loose art fallback roots (primary) | `/var/www/vltksource_new/vl_update_27/Client 6.0/{spr,settings,ui,...}` |
| Server/client scripts (primary provenance) | `/var/www/vltksource_new/vl_update_27/{Client 6.0,Server 6.0}/.../script` |
...
| engine.dll (to re-derive hash if ever needed) | `/var/www/vltksource_new/vl_update_27/Client 6.0/engine.dll` |
